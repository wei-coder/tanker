...
robot = ArmRobot.ArmRobot(addr=0x6f,left_id=1,right_id=2,left_trim=LEFT_TRIM, right_trim=RIGHT_TRIM)
...
#                     forever.
robot.forward(150, 3.0)   # Move forward at speed 150 for 1 second.
robot.left(200, 1.5)      # Spin left at speed 200 for 0.5 seconds.
robot.forward(150, 2.0)   # Repeat the same movement 3 times below...
robot.left(200, 1.0)
